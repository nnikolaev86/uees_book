%% ПРИМЕР 1: Изчисляване на собствени и взаимни проводимости на едномашинна ЕЕС
clear all; clc;
fprintf('ПРИМЕР 1: Изчисляване на собствени и взаимни проводимости на едномашинна ЕЕС\n\n')
